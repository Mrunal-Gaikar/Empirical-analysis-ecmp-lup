def HashHelperFunction(topo,src,dst,packet):
    ...
    src_port=str(packet.payload.payload.srcport)
    dst_port=str(packet.payload.payload.dstport)
    protocol=str(packet.payload.protocol)
    flowHash = hash(str(packet.payload.srcip)+str(packet.payload.dstip))
    #flowHash = hash(str(packet.payload.srcip)+str(packet.payload.dstip)+src_port+dst_port+protocol)
    print("src =",packet.payload.srcip)
    print("dest=",packet.payload.dstip)
    print("src p =",str(packet.payload.payload.srcport))
    print("dest p=",str(packet.payload.payload.dstport))
    print("\n flow hash for src n dest=",flowHash)
